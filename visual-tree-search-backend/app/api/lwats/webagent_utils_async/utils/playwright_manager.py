...
async def auto_login(page, credentials, starting_url):
    ...
    try:
        ...
        if 'username_field' in credentials and 'username' in credentials:
            ...
            print(f"Filling username field with: {credentials['username'][:2]}{'*' * (len(credentials['username']) - 4)}{credentials['username'][-2:]}")
        ...
        if 'password_field' in credentials and 'password' in credentials:
            ...
            print(f"Filling password field with: {'*' * len(credentials['password'])}")
        ...
        # TODO: add success indicator check
        print("Note: Success indicator check not implemented yet")
