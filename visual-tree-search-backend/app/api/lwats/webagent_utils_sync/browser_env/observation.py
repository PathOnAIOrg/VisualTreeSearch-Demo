...
import time
def extract_page_info(page, fullpage, log_folder):
    page_info = {}
    _pre_extract(page)
...
def extract_screenshot(page):
    ...
    Returns:
        A screenshot of the page, in the form of a 3D list (height, width, rgb).
    """
    ...
    with io.BytesIO(png_bytes) as f:
        ...
        # convert to a list of lists (height, width, rgb)
...
def observe_features(page_info, features, elements_filter, log_folder, fullpage=True):
